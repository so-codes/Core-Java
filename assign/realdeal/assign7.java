...
class assign7 extends JFrame implements ActionListener {
    ...
    private String months[] = { "Jan", "feb", "Mar", "Apr",
            "May", "Jun", "July", "Aug",
            "Sup", "Oct", "Nov", "Dec" };
    private String years[] = { "2000", "2001", "2002",
            "2003", "2004", "2005", "2006",
            "2007", "2008", "2009", "2010",
            "2011", "2012", "2013", "2014",
            "2015", "2016", "2017", "2018",
    ...
    public assign7() {
        ...
        stuffcng = new JTextArea();
        stuffcng.setFont(new Font("Arial", Font.PLAIN, 15));
        stuffcng.setSize(200, 75);
        stuffcng.setLocation(580, 175);
        stuffcng.setLineWrap(true);
        c.add(stuffcng);
